...
production `phantom_protocol` deployment. Combines build-time choices with
...
| Phantom Protocol hybrid PQ handshake (pinned, production path) | ~1.06 ms → ~945 conn/sec/core |
