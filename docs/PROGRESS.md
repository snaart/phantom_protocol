...
| Metric | Value |
| --- | --- |
| Tests passing | **256 / 256** (215 unit + 24 negative-security + 5 proptest + 3 fuzz + 1 alkahest + 1 runtime-integration + 5 cavp; +2 tcp_integration `#[ignore]`) — `+1` unit from 3.4.6 e2e mirror, `+5` integration from Phase 5.4 CAVP |
